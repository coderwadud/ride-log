...
### 🗺️ ৪. ১০০% ফ্রি GPS লাইভ ট্র্যাকিং ও ৩ দিনের রুট প্লে-ব্যাক (Live GPS & 3-Day Route Playback)
- **১০০% ফ্রি ওপেন-স্ট্রিট ম্যাপ (OpenStreetMap + Leaflet)**: কোনো পেইড Google Maps API বা ক্রেডিট কার্ড ছাড়া সম্পূর্ণ ফ্রিতে ফুল-স্ক্রিন ম্যাপ ভিউ।
- **লাইভ রাইড ট্র্যাকিং (Live HUD)**:
  - স্পিডোমিটার (km/h), অতিক্রান্ত দূরত্ব (km), সময়কাল ও টপ স্পিড রিয়েল-টাইমে প্রদর্শন।
  - ম্যাপের উপর লাইভ ট্রিপ ট্রেইল ও পালসিং রাইডার মার্কার।
  - Start, Pause এবং Finish Ride এর স্বয়ংক্রিয় সেভ সুবিধা।
- **গত ৩ দিনের রুট প্লে-ব্যাক (Animated 3-Day Playback)**:
  - গত ৩ দিনের যেকোনো রাইড সিলেক্ট করে **Play (▶️)** চাপলে ম্যাপের উপর দিয়ে **মোটরসাইকেল আইকন অ্যানিমেশন হয়ে চলবে**।
  - প্লে-ব্যাক স্পিড কন্ট্রোল: **1x, 2x, 4x, 8x**।
  - ইন্টারেক্টিভ টাইমলাইন স্লাইডার (ড্র্যাগ করে ট্রিপের যেকোনো মুহূর্তের স্পিড ও অবস্থান দেখা যায়)।
  - ট্রিপ সামারি: মোট দূরত্ব, সময়, টপ স্পিড, গড় স্পিড ও স্টার্ট/এন্ড মার্কার।
  - সম্পূর্ণ অফলাইন-বান্ধব IndexedDB স্টোরেজ।

### 📄 ৫. প্রাইভেট ডকুমেন্ট ভল্ট ও মেয়াদ ট্র্যাকিং (Document Storage & Expiry)
